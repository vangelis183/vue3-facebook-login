import { openBlock, createElementBlock, normalizeClass, toDisplayString, normalizeStyle } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.type === 'minimal' ? (openBlock(), createElementBlock("button", {
    key: 0,
    onClick: _cache[0] || (_cache[0] = function () {
      return $options.logInWithFacebook && $options.logInWithFacebook(...arguments);
    }),
    class: normalizeClass(["minimal btn-def", {
      dark: $props.theme === 'dark',
      light: $props.theme === 'light',
      dark: $props.theme !== 'light'
    }])
  }, toDisplayString($props.text || "Login with Facebook"), 3)) : $props.type === 'custom' ? (openBlock(), createElementBlock("button", {
    key: 1,
  ...
  }, toDisplayString($props.text || "Login with Facebook"), 7)) : (openBlock(), createElementBlock("button", {
    key: 2,
    onClick: _cache[2] || (_cache[2] = function () {
      return $options.logInWithFacebook && $options.logInWithFacebook(...arguments);
    }),
    class: normalizeClass(["normal btn-def", {
      dark: $props.theme === 'dark',
      light: $props.theme === 'light'
    }])
  }, toDisplayString($props.text || "Login with Facebook"), 3));
}
...
script.__scopeId = "data-v-326084e2";
